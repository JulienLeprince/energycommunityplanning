...
range_nb_of_buildings_initially = 73
...
for i in iterations:
        ...
        for s in range(scenarios):
            ...
            for bi in buildings:
                ...
                if bi != b:
                    ...
                    print('O_inv_blg: ', O_inv_blg)
                    print('O_co2_blg: ', O_co2_blg)
                    print('O_slk: ', O_slk)
    ...
    file = path_out + 'ecp_distributed_stoch_' + version + '_nbblgs' + str(len(buildings))
    # Write
    for s in range(scenarios):
