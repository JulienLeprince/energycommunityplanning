...
# Economic data
tax_electricity = 0.10458  # EUR/kWh - source https://www.belastingdienst.nl/wps/wcm/connect/bldcontentnl/belastingdienst/zakelijk/overige_belastingen/belastingen_op_milieugrondslag/tarieven_milieubelastingen/tabellen_tarieven_milieubelastingen
tax_naturalgas = 0.26001 / 10  # EUR/m3 * kWh/m3  - source https://www.belastingdienst.nl/wps/wcm/connect/bldcontentnl/belastingdienst/zakelijk/overige_belastingen/belastingen_op_milieugrondslag/tarieven_milieubelastingen/tabellen_tarieven_milieubelastingen
tariff_elec_transmission_and_distribution = 27.44 / 30 / 24 * 0.93632126  # USD/month * day/month * hour/day * EUR/USD - source https://www.acm.nl/sites/default/files/documents/distribution-tariffs-sec-electricity-2021.pdf  - https://www.acm.nl/en/publications/acm-takes-account-energy-transition-when-setting-network-tariffs
